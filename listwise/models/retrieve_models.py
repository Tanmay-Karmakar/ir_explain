...
root_dir = Path('/a/administrator/codebase/neural-ir/RankingExplanation_bkp/')
...
def evaluate(dataset: str, rm3: bool, fold_name: str, output: str, hits_num: int) -> None:
    ...
    out_dir = Path('/a/administrator/codebase/neural-ir/RankingExplanation_bkp/Eval_results/') / fold_name / output
